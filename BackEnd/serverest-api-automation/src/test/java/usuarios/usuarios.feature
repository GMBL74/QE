Feature: CRUD de Usuarios - API ServeRest
  ...
  Background:
    * url baseUrl
    # optimización: los datos de prueba se generan una sola vez por feature
    * def newUser = callonce read('helpers.js')
  ...
  Scenario: Buscar usuario por ID válido
    # reutiliza el usuario creado en "Registrar un nuevo usuario con datos válidos"
